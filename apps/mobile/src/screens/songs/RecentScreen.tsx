...
const RecentScreen: React.FC = () => {
  ...
  const loadRecentSongs = useCallback(async () => {
    try {
      setLoading(true);
      // TODO: Implement actual recent songs loading logic
          ...
          <View style={styles.songDetails}>
            ...
            {item.lastViewed && (
              <Text style={styles.lastViewed}>
                Last viewed: {item.lastViewed.toLocaleDateString()}
              </Text>
            )}
          </View>
        </View>
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyTitle}>No Recent Songs</Text>
      <Text style={styles.emptySubtitle}>
        Songs you've recently viewed will appear here
      </Text>
    </View>
  );
